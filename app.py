...
st.markdown("""
    ...
    .summary-item { 
        ...
        border-bottom: 1px solid #f9f9f9; padding-bottom: 2px;
...
with st.sidebar:
    ...
    st.divider()
    # 언어 설정: "Language"만 표시, "Korean/English"로 변경
